...
print("AdaBoost")
#================================================================================================================
clfAdaBoost = GradientBoostingClassifier(random_state=84)

# specify parameters and distributions to sample from
param_distAdaBoost = {'n_estimators': [10, 50, 100, 150], 'learning_rate': [0.1,0.01,1.0,10.0],'algorithm':{'SAMME','SAMME.R'}}



listAlgorithms = [clfRF,clfSVC,clfKNN,clfLR,clfMLP,clfAdaBoost]
listParams = [param_distRF,param_distSVC,param_distKNN,param_distLR,param_distMLP,param_distAdaBoost]
listNames = ["RF", "SVM", "KNN", "LR", "MLP","AB"]
